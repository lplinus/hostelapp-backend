...
from .views import (HomePageAPIView,AdminHomePageViewSet,AdminWhyUsViewSet,ContactMessageAPIView,PricingAPIView,AboutAPIView,ContactAPIView
)
...
urlpatterns = [
    ...
    path("contact/message/", ContactMessageAPIView.as_view(), name="contact-message-api"),
